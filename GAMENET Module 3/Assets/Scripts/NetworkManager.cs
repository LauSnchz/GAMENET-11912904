...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private Dictionary<int, GameObject> playerListGameObjeccts;
    ...
    public void OnCreateRoomButtonClicked()
    {
        ...
        if (GameMode != null)
        {
            ...
            // Game modes: rc = racing, dr = death race
    ...
    public override void OnJoinedRoom()
    {
        ...
        if(playerListGameObjeccts == null)
        {
            playerListGameObjeccts = new Dictionary<int, GameObject>();
        }
        ...
        foreach(Player player in PhotonNetwork .PlayerList)
        {
            ...
            playerListGameObjeccts.Add(player.ActorNumber, playerListItem);
        }
    ...
    public override void OnPlayerEnteredRoom(Player newPlayer)
    {
        ...
        playerListGameObjeccts.Add(newPlayer.ActorNumber, playerListItem);
    ...
    {
        Destroy(playerListGameObjeccts[otherPlayer.ActorNumber].gameObject);
        playerListGameObjeccts.Remove(otherPlayer.ActorNumber);
    ...
    public override void OnLeftRoom()
    {
        ...
        foreach(GameObject playerlistGameObject in playerListGameObjeccts.Values)
        {
            Destroy(playerlistGameObject);
        }

        playerListGameObjeccts.Clear();
        playerListGameObjeccts = null;
    }

    public override void OnPlayerPropertiesUpdate(Player targetPlayer, ExitGames.Client.Photon.Hashtable changedProps) // calls whenever a property of a player changes
    {
        GameObject playerlistGameObject;
        if(playerListGameObjeccts.TryGetValue(targetPlayer.ActorNumber, out playerlistGameObject))
        {
            object isPlayerReady;
